	...
	[11] = function()
		...
		return function(m, n, o, p)
			...
			q.TitleLabel = k('TextLabel', {
				FontFace = Font.new('rbxasset://fonts/families/Balthazar.json', Enum.FontWeight.Medium, Enum.FontStyle.Normal),
				Text = m,
				TextColor3 = Color3.fromRGB(240, 240, 240),
				TextSize = 13,
				TextXAlignment = Enum.TextXAlignment.Left,
		...
		function o.New(p, q, r, s)
			...
			x.Frame = k('TextButton', {
				...
				k('TextLabel', {
					...
					TextColor3 = Color3.fromRGB(255, 255, 255),
					TextTransparency = 0,
					FontFace = Font.new('rbxasset://fonts/families/Balthazar.json', Enum.FontWeight.Regular, Enum.FontStyle.Normal),
					TextSize = 12,
					TextXAlignment = 'Left',
					TextYAlignment = 'Center',
